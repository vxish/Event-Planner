...
public class ClubsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList = findViewById(R.id.ClubrecycleView);
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<EventModel, EventModelViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<EventModel, EventModelViewHolder>
                (EventModel.class, R.layout.listcard,EventModelViewHolder.class,mDatabase) {
            @Override
            protected void populateViewHolder(final EventModelViewHolder viewHolder, EventModel model, int position)
            {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(ClubsActivity.this, MoreInfoActivityClbs.class);
                        intent.putExtra("event_IDclb", post_key);
