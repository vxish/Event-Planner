...
public class SUActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList = findViewById(R.id.SUrecycleView);
    ...
    protected void onStart() {
        super.onStart();
        final FirebaseRecyclerAdapter <EventModel, EventModelViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<EventModel, EventModelViewHolder>
                (EventModel.class, R.layout.listcard,EventModelViewHolder.class,mDatabase) {

            @Override
            protected void populateViewHolder(final EventModelViewHolder viewHolder, final EventModel model, int position)
            {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(SUActivity.this, MoreInfoActivity.class);
                        intent.putExtra("event_ID", post_key);
